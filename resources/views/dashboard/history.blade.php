                    ...
                    <div class="p-2 text-gray-900 dark:text-gray-100">
                        <div class="space-y-4">
                            ...
                            @foreach ($tickets as $ticket)
                                <div x-data="{ openModal_{{ $ticket->id }}: false }"
                                    ...
                                    <div class="flex items-center justify-between text-sm">
                                        <span
                                            ...
                                            @if ($ticket->status->titolo === 'Chiuso') bg-red-100 text-red-700 @endif">
                                            {{ ucfirst($ticket->status->titolo) }}
                                        </span>

                                        <div class="flex gap-2">
                                            <button @click="openModal_{{ $ticket->id }} = true" type="button"
                                    ...
                                    <!-- Modale -->
                                    <div x-show="openModal_{{ $ticket->id }}" x-cloak
                                        ...
                                        <div @click.away="openModal_{{ $ticket->id }} = false"
                                            ...
                                            <h2 class="text-xl font-bold text-gray-800 dark:text-gray-100 mb-4">Dettagli
                                                Ticket</h2>
